...
---- added below 20210811ae                                 
            ,   ( SELECT  DISTINCT 
--                          case when CL_QANSWER_QA.QUEST_ID  in (  '21061003' ,'2106100301' ) and  CL_QANSWER_QA.quest_answer is not null then  CL_QANSWER_QA.quest_answer 
--                          end   quest_answer 
                          
                          case 
                                when CL_QANSWER_QA.QUEST_ID  in (  '21061003'  ) and  CL_QANSWER_QA.quest_answer like 'First%'    Then '1'  
                                when CL_QANSWER_QA.QUEST_ID  in (  '21061003'  ) and  CL_QANSWER_QA.quest_answer like 'Second%'   Then '2' 
                                when CL_QANSWER_QA.QUEST_ID  in (  '21061003'  ) and  CL_QANSWER_QA.quest_answer like 'Third%'    Then '3' 
                                when CL_QANSWER_QA.QUEST_ID  in (  '21061003'  ) and  CL_QANSWER_QA.quest_answer is not null 
                                     and (
                                               CL_QANSWER_QA.quest_answer not like 'First%'
                                          and  CL_QANSWER_QA.quest_answer not like 'Second%'
                                          and  CL_QANSWER_QA.quest_answer not like 'Third%'
                                          ) 
                                    then      CL_QANSWER_QA.quest_answer 
                                    
                                when CL_QANSWER_QA.QUEST_ID  in (  '2106100301'  ) and  CL_QANSWER_QA.quest_answer like 'First%'    Then '1'  
                                when CL_QANSWER_QA.QUEST_ID  in (  '2106100301'  ) and  CL_QANSWER_QA.quest_answer like 'Second%'   Then '2' 
                                when CL_QANSWER_QA.QUEST_ID  in (  '2106100301'  ) and  CL_QANSWER_QA.quest_answer like 'Third%'    Then '3'
                                when CL_QANSWER_QA.QUEST_ID  in (  '2106100301'  ) and  CL_QANSWER_QA.quest_answer like 'Booster%'  Then '3'   
                                when CL_QANSWER_QA.QUEST_ID  in (  '2106100301'  ) and  CL_QANSWER_QA.quest_answer is not null 
                                     and (
                                               CL_QANSWER_QA.quest_answer not like 'First%'
                                          and  CL_QANSWER_QA.quest_answer not like 'Second%'
                                          and  CL_QANSWER_QA.quest_answer not like 'Third%'
                                          and  CL_QANSWER_QA.quest_answer not like 'Booster%'
                                          ) 
                                    then      CL_QANSWER_QA.quest_answer                                     
                           end   quest_answer                           
