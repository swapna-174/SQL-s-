...
--    LEFT OUTER JOIN clarity_loc parloc ON dep3.PARENT_HOSP_ID = parloc.LOC_ID
...
LEFT outer join GROUPER_COMPILED_RECORDS gcr ON gcr.COMPILED_REC_LIST_VALUE = cm.MEDICATION_ID
