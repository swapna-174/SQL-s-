...
---- added below 20211006ae                                 
            ,   ( SELECT  DISTINCT 
                            ...
                            case
                                when CL_QANSWER_QA.QUEST_ID  in (  '21061003' ,'2106100301' ) and  CL_QANSWER_QA.quest_answer > 2 then '3'
                                when CL_QANSWER_QA.QUEST_ID  in (  '21061003' ,'2106100301' ) and  CL_QANSWER_QA.quest_answer < 3 then  CL_QANSWER_QA.quest_answer                                     
                           end   quest_answer                           
...
------------------------------------repurposed to denote whether it is a FULL or HALF dose of the vaccine
                        ,     CASE
                                    WHEN BASE_POP.IMMUNE_DATE IS NOT NULL    THEN 'FULL'
--                                    WHEN X   THEN 'FULL'
--                                    WHEN Y   THEN 'HALF'
