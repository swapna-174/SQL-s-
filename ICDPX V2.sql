...
FROM
	...
	INNER JOIN (SELECT
									max(log.SURGERY_DATE) "SURGERY_DATE"
...
WHERE
	TRUNC(acct.DISCH_DATE_TIME) BETWEEN to_date('2015-02-01', 'yyyy-mm-dd') AND to_date('2015-04-14', 'yyyy-mm-dd')
	AND 
	dep.REV_LOC_ID = 10083
	AND pxlist.FINAL_ICD_PX_ID IN 
	('5643'
	,'5656'
	,'5665'
	,'5668'
