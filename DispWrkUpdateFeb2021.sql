...
--                AND odi.ORDER_MED_ID =524222297            -------- 504865862
...
(
                ...
                SELECT distinct
                odiadm.ORDER_MED_ID
--                ,odiadm.CONTACT_DATE_REAL    ---- REMOVE THIS IN MAIN QUERY
                ,odiadm.ORD_CNTCT_TYPE_C
--                ,odiadm.CONTACT_DATE        ---- REMOVE THIS IN MAIN QUERY
--                ,odiadm.INP_ADMIN_LINE_NO    ---- REMOVE THIS IN MAIN QUERY
--                ,odiadm.INP_ADMIN_DISP_LNK  ---- REMOVE THIS IN MAIN QUERY
                ,odiadm.ADMIN_DISPDATREAL
                ,odiadm.DISPENSE_CODE_C
--                , mar.LINE               ---- REMOVE THIS IN MAIN QUERY
                ,mar.TAKEN_TIME
                ,mar.USER_ID
...
--                ,odiadm.CONTACT_DATE_REAL    ---- REMOVE THIS IN MAIN QUERY
                ...
                LEFT outer JOIN ORDER_DISP_INFO odiadm ON odiadm.ORDER_MED_ID = ordadm.ORDER_MED_ID 
                LEFT OUTER JOIN mar_admin_info mar ON odiadm.ORDER_MED_ID = mar.ORDER_MED_ID AND odiadm.INP_ADMIN_LINE_NO = mar.LINE
                LEFT OUTER JOIN ZC_EDIT_MAR_RSLT zcmr ON mar.MAR_ACTION_C = zcmr.RESULT_C
                WHERE
              mar.MAR_ACTION_C IN ('1', '6', '102', '105', '113', '114', '115','1002')
)a
          where 
...
,vrxd.CONTACT_DATE_REAL  "CDR"    ----- UNIQUE IDENTIFIER ADDED ON 4/15/2020
,marcnt.ADMIN_CNT "ADMIN_COUNT"    ----- UPDATE COLUMN  2/22/2021
,marcnt.ADMIN_ACTION "ADMIN_ACTION"  ------ NEW COLUMN  2/22/2021
,marmd.ADMIN_ACTION  "BULK_ADMIN_ACTION"        ----  NEW COLUMN 2/22/2021
,vrxd.DISP_PAT_CLASS "DISPENSE_PATIENT_CLASS"   ------ NEW COLUMN 2/22/2021
