...
--
-- Has the pt's temp remained above 36C/96.8F from Case/Incision Start to Procedure Finish?
    ...
    FROM PAT_POP pp
        LEFT OUTER JOIN
            ...
            SELECT DISTINCT
                ...
                , t2."Measure ID"
                , CASE
                        WHEN t2."Measure ID" = '891'  THEN 'Temp >= 36'
                    END AS "Measure Name"
                , CASE
                    WHEN t2."Measure ID" = '891' 
--                        AND t2."Measure Value" < 36 
                        AND t2."Measure Value" < 96.8
