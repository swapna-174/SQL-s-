...
FROM CLARITY.CLARITY_TDL_TRAN tdl
    INNER JOIN CLARITY.CLARITY_EAP eap ON tdl.PROC_ID = eap.PROC_ID
WHERE tdl.ORIG_SERVICE_DATE >= ADD_MONTHS(SYSDATE, -12)  
...
GROUP BY  tdl.PROC_ID, eap.PROC_NAME