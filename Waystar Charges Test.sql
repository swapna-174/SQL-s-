...
--   and 
--WHERE HAR.HSP_ACCOUNT_ID IN (433961544,500940928,433295190,435502527)
--WHERE HAR.HSP_ACCOUNT_ID IN (433295190,435502527)
--    AND HAR.HSP_ACCOUNT_ID IN (433295190,435502527)
    AND HAR.HSP_ACCOUNT_ID = 431965584
