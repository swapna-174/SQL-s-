...
--                                        ,tmpser.prov_name  
--                                        ,tmpser.prov_type
--                                         ,pat_enc_chng_appt.NEW_PROV_ID 
--                                        ,pat_enc_chng_appt.old_prov_id                                       
--                                      , ROW_NUMBER() 
...
--		This code examines table APPT_UTIL_SNAPSHOT for the existence of generic provider 8274 (UNITED HEALTH CENTER) and UTIL_SNAP_CHANGE has a value of 0
     	left join (
              ...
              --									and trunc(f_appt.APPT_DTTM) ='13-FEB-2021'
...
--    AND  ( tmpser.prov_id IS NULL OR (    tmpser.NEW_PROV_ID  <> '8274'     -- EXCLUDE WHERE OLD_PROV_ID =  '8274'	--UNITED HEALTH CENTERS @ PETERS CREEK PARKWAY
--                                      AND tmpser.old_prov_id  <> '8274' )
--                                                                     )  
                          ...
                          SELECT  DISTINCT
                                  ...
                                  , CASE 
                                   ...
                                   , SUBSTR(EMERGENCY_CONTACTS.MOTHER_NAME, 0,
                                    ...
                                    , CASE WHEN PATIENT.IS_PHONE_REMNDR_YN = 'Y'   THEN 'Y (YES)'
                                           WHEN PATIENT.IS_PHONE_REMNDR_YN IS NULL THEN 'Y (YES)'
                                           WHEN PATIENT.IS_PHONE_REMNDR_YN = 'N'   THEN 'N (NO)'
                                           ELSE    'Y (YES)'
