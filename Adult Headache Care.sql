...
--            ORDER BY mar.TAKEN_TIME
    ...
    WHERE 
        ...
        AND hsp.ADT_ARRIVAL_TIME <= to_date('2014-06-30 00:00:00', 'yyyy-mm-dd hh24:mi:ss')
        AND ROUND((hsp.ADT_ARRIVAL_TIME - pat.BIRTH_DATE) / 365) >= 18
        AND v_enc.TEMPERATURE < 100.5
        AND mar.MAR_ACTION_C = 1
        AND adt.DEPARTMENT_ID = 1000100009
