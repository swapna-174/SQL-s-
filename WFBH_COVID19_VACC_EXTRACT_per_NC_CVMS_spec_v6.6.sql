...
---- added below 20210811ae                                 
            ,   ( SELECT  DISTINCT 
                          case when CL_QANSWER_QA.QUEST_ID  =  '21061003' and  CL_QANSWER_QA.quest_answer is not null then  CL_QANSWER_QA.quest_answer 
                          end   quest_answer 
                  FROM  CL_QANSWER_QA 
                 WHERE  1=1
                   AND  CL_QANSWER_QA.QUEST_ID  in ( '21061003') ---	MR IMM CURRENT DOSE NUMBER	---- Which dose in the series is being administered
