...
(
    ...
    '19285',
    '19125')
--    AND orl.SURGERY_DATE >= '1-jul-2019'
    and orl.SURGERY_DATE >= EPIC_UTIL.EFN_DIN ('{?Start_Date}')    
...
(
    ...
    ,enc.HSP_ACCOUNT_ID
    ,prc.PRC_NAME
    ,op.DESCRIPTION  "ENCOUNTER_ORDER"
    ,ppl.LOG_ID
    ,ppl.PRE_OP_DX
    ,ppl.PRE_OP_DX_CODE
    ...
    AND enc.CONTACT_DATE > ppl.SURGERY_DATE-90  
    AND 
    ...
    AND enc.ENC_TYPE_C NOT IN (109,117,61,70,105,99,2507,3)   
