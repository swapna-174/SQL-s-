...
--              END                                                               LookUP_admin_name    --- parent vfc --1/26/2021   from spec per CVMS  
 
--           ,  '34C001'                                                            vtrcks_prov_pin

            , CASE  
                      WHEN  LOC2.LOC_id IN (   '100000'  )     THEN      --	  PARENT WAKE FOREST 
                            CASE  WHEN  ENC_DEP.REV_LOC_ID  =  '10035'         THEN  '34C046'  ---- PEACE HAVEN LOCATIONS
                                  WHEN  ENC_DEP.REV_LOC_ID  =  '10036'         THEN  '340030'  ---- PPI 03 NON-HBC FAMILY MEDICINE  PEACE HAVEN LOCATION
                             ELSE                                                    '34C001' 
                             END
...
--                ELSE                            '34C001'   --Administer Location is the Initial Inventory location                         
--              END                                                               LOOKUP_vtrcks_prov_pin     --- vfc for admin  location  '40166742'  --1/26/2021 remove from spec per CVMS 
--
-- 
