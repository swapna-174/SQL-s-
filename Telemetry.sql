select --pat.PAT_NAME--    , peh.PAT_ID    --, 
pat.pat_mrn_id
    , peh.HSP_ACCOUNT_ID
...
--    and cl_q.quest_id IN ('100122') -- , '100123')
    and cl_q.quest_id IN ('100122', '100123', '101572', '152600', '152564','101579', '152565', '152587','152588', '152589', '152590', '152591', '152565') -- , '100123')
                                 --and cl_qov.QUESTION like '%Reason%'           
